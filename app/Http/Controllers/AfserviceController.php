...
class AfserviceController extends Controller
{
    /**
     * Display a listing of the resource.
     */
    
    public function afservice()
    {
        $fserv = a_fservice::with('unit','location')->paginate(1000);
        return view('A-FSERVICE.afservice', compact('fserv'));
    }
    ...
    public function create()
    {
        ...
        return view('A-FSERVICE.create', compact('units', 'locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('A-FSERVICE')->with('success', 'Product added successfully');
    }
    ...
    {
        {
            ...
            return view('A-FSERVICE.show', compact('fserv'));
        }
    }
    ...
    {
        {
            ...
            return view('A-FSERVICE.edit', compact('fserv', 'units', 'locations'));
        }
    }
    ...
    public function update(Request $request, string $id)
    {
        try {
            ...
            return redirect()->route('A-FSERVICE')->with('success', 'Product updated successfully');
        } catch (\Exception $e) {
            // Tangani kesalahan jika produk tidak ditemukan atau kesalahan lainnya
            return redirect()->route('A-FSERVICE')->with('error', 'Failed to update product: ' . $e->getMessage());
        }
    }
    /**
    ...
    {
        {
            ...
            return redirect()->route('A-FSERVICE')->with('success', 'deleted successfully');
        }
    }
}
