        ...
        <div class="card-body">
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" name="unit" class="form-control" placeholder="Title" value="{{ $dv->unit->unit }}" readonly>
                </div>
                <div class="col">
                    <label class="form-label">Location</label>
                    <input type="text" name="location" class="form-control" placeholder="Title" value="{{ $dv->location->location }}" readonly>
                </div>
                <div class="col">
                    <label class="form-label">Merk</label>
                    <input type="text" name="merk" class="form-control" placeholder="merk" value="{{ $dv->merk }}" readonly>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label class="form-label">Type</label>
                    <input type="text" name="type" class="form-control" placeholder="Type" value="{{ $dv->type }}" readonly>
                </div>
                <div class="col">
                    <label class="form-label">Firmware</label>
                    <input type="text" name="firmware" class="form-control" placeholder="Firmware" value="{{ $dv->firmware }}" readonly>
                </div>
                <div class="col">
                    <label class="form-label">Channel</label>
                    <input type="text" name="channel" class="form-control" placeholder="Channel" value="{{ $dv->channel }}" readonly>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label class="form-label">HDD</label>
                    <input type="text" name="hdd" class="form-control" placeholder="Hdd" value="{{ $dv->hdd }}" readonly>
                </div>
                <div class="col">
                    <label class="form-label">Local IP</label>
                    <input type="text" name="localip" class="form-control" placeholder="Local IP" value="{{ $dv->localip }}" readonly>
                </div>
                <div class="col">
                    <label class="form-label">PO Number</label>
                    <input type="text" name="ponumber" class="form-control" placeholder="PO Number" value="{{ $dv->ponumber }}" readonly>
                </div>
            </div>
...
<div class="modal fade" id="addCctvModal{{ $cctv->id }}" tabindex="-1" role="dialog" aria-labelledby="addCctvModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('cctv.store', ['id' => $dv->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
