            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4" onclick="window.location.href = '{{ route('U-group') }}';"
                        ...
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4" onclick="window.location.href = '{{ route('unit') }}';"
                            style="cursor: pointer;">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="window.location.href = '{{ route('location') }}';" style="cursor: pointer;">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4"
                            onclick="window.location.href = '{{ route('CCTV') }}';" style="cursor: pointer;">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4" onclick="window.location.href = '{{ route('FACE') }}';"
                            style="cursor: pointer;">
