...
<div class="container-fluid">
    <div class="card shadow mb-3">
        <div class="card-header py-3 d-flex align-items-center justify-content-between">
            <h6 class="mb-0 font-weight-bold text-primary">FACE RECOGNITION</h6>
        </div>
        <form action="{{ route('A-FACE.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="localip" class="form-control" placeholder="Local IP">
                    </div>
                    <div class="col-md-4 mb-3">
