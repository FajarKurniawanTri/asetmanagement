...
<head>
    ...
    <link rel="icon" type="{{ asset('admin_asset/image/x-icon') }}" href="{{ asset('admin_asset/img/favicon.ico') }}" />

    <!-- Custom background image style -->
    <style>
        .bg-login-image {
            background-image: url('{{ asset('admin_asset/img/logo.png') }}');
...
<body class="bg-gradient-primary">
    ...
    <div class="container-lg"> <!-- Menggunakan container-lg untuk ukuran besar -->
